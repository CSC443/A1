...
# Binaries
all:write_blocks_seq read_blocks_seq write_lines read_ram_seq read_blocks_rand read_ram_rand
...
clean:  
	rm write_blocks_seq read_blocks_seq write_lines read_ram_seq read_blocks_rand read_ram_rand